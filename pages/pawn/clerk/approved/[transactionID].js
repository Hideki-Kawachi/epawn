...
function ApprovedTransactionID({
	currentUser,
	transactionData,
	itemData,
	customerData,
	...
	useEffect(() => {
		...
		pawnTicketData.forEach((pt) => {
			...
			tempPawnTicketList.push({
				ptID: pt.pawnTicketID,
...
export default ApprovedTransactionID;
