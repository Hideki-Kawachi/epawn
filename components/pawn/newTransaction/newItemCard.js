...
function NewItemCard({ id, deleteItem }) {
	...
	return (
		<div className="flex w-full gap-3 p-2 bg-gray-100 border-2 border-gray-500 border-solid">
			<button
				className="p-2 text-gray-100 bg-red-300 rounded-full w-9 aspect-square"
				type="button"
