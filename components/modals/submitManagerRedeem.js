      ...
      <div id="modal-content-area">
        <div className="px-20 pt-10 pb-10 bg-gray-100 border-2 rounded-xl min-w-fit">
          ...
          <p className="mb-5 text-base text-center font-nunito">
            Are you sure you want to approve the <b> Redemption </b> of <br />
          ...
          <p className="mt-4 text-base text-center font-nunito">
            For a total of <b>Php {convertFloat(amountToPay)}</b>
          </p>

          <p className="text-sm text-center text-gray-400 font-nunito">
            The new Pawn Ticket and receipt will be automatically printed after
            clicking <b>Submit</b>.
          </p>
